...
- It can be challenging to learn accurate value estimates. Q-learning, for example, is prone to overestimating values (Hasselt, 2010). This work is extended to TD3.  <img src="https://github.com/ehddnr747/duju-ml2-takehome/blob/master/images/fig3.png" width="800">   
